...
<div id="page" class="hfeed site">
	...
	<header id="masthead" class="site-header" role="banner">
		...
		<div style="outline:1px solid red; background-color:teal; height:4em;">

				<div id="my-mega-menu-widget" class="" style="float:left; width:16%; outline:1px solid orange;">
    ...
    if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('my_mega_menu') ) : ?><?php endif; ?>
		...
		<div id="centroDer" class="" style="float:right; width:20%; background-color:orange;"> 
