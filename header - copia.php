...
<div id="page" class="hfeed site">
	...
	<div id="main" class="site-main">
			...
			<div>
				<div id="my-mega-menu-widget" class="" style="float:left; width:23%; outline:1px solid aqua;">
			<?php /* Widgetized sidebar */
    if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('my_mega_menu') ) : ?><?php endif; ?>
				</div>
				<div id="centroCen" class="" style="float:left; width:46%; outline:1px solid red;"><?php if ( function_exists( "easingsliderlite" ) ) { easingsliderlite(); } ?></div>
				<div id="centroDer" class="" style="float:left; width:30%; outline:1px solid blue;"> 
